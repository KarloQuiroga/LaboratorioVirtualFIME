                ...
                <div
                    ...
                    <div class="row">
                        <div class="col my-2 text-center">
                            ...
                            <form action="../static/php/controlador_olvide_password.php" method="post" class="fs-2 gap-3 d-flex flex-column align-items-center">
                                <div class="row mx-5 gap-3 d-flex justify-content-between">
                                    <input
                                        ...
                                        class="bg-light p-0 col-form-label"
                                        required="required">
                                </div>
